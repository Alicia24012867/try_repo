...
def _previous_evidence_paths(context: CycleContext) -> tuple[str, ...]:
    ...
    return (
        ...
        f"{root}/comparison/frontend_summary.csv",
        f"{root}/comparison/cec_summary.csv",
        f"{root}/comparison/cec_by_flow.csv",
        f"{root}/comparison/qor_delta.csv",
        f"{root}/comparison/qor_delta_by_flow.csv",
        f"{root}/comparison/flow_vote_summary.csv",
        f"{root}/comparison/multi_flow_summary.json",
